...
const Sidebar = () => {
    ...
    return (
        <aside className="group fixed left-0 top-0 h-screen w-20 hover:w-64 bg-[#F7F7F7] flex flex-col z-50 border-r border-slate-200 transition-all duration-300">
            {/* Logo Area */}
            ...
            <div className="p-4 border-t border-slate-200 overflow-hidden">
                <button className="flex items-center gap-4 px-3 py-3 w-full rounded-lg text-slate-500 hover:bg-slate-200/50 hover:text-black transition-colors duration-300">
